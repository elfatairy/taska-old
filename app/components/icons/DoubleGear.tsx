...
const SvgDoubleGear = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g id="double-gear_svg__SVGRepo_iconCarrier">
      <defs>
        <style>
          {
